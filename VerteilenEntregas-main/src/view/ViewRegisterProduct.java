...
import controllers.ControllerReadWriteTextProduct;
...
import model.dao.ModelProductDAO;
...
public class ViewRegisterProduct extends javax.swing.JFrame {
    ...
    private static ViewRegisterProduct viewRegisterProduct;
    public ControllerReadWriteTextProduct controller = new ControllerReadWriteTextProduct();
    ...
    public static ViewRegisterProduct getViewRegisterProduct() {
        if (viewRegisterProduct == null) {
            viewRegisterProduct = new ViewRegisterProduct();
        }
    ...
    public void cleanFields() {
        ...
        jTextFieldStackingMaxCapacity.setText("");
    }

    public void loadTable(List<ModelProduct> productList) {
        DefaultTableModel tabela = (DefaultTableModel) jTableDistributor.getModel();
        tabela.setRowCount(0);

        int linha = 0;

        for (ModelProduct model : productList) {
            tabela.insertRow(linha, new Object[]{
                model.getName(),
                model.getLoadCategory(),
                model.getStackingCapacity(),});
            linha++;
        }
    }
    ...
    public void loadTableDatabase() {
        ...
        ModelProductDAO modelDao = new ModelProductDAO();

        for (ModelProduct model : modelDao.read()) {
    ...
    public int readTableDatabaseForId(int id) {
        ...
        ModelProductDAO modelDao = new ModelProductDAO();
        int i = 0;
        for (ModelProduct model : modelDao.readID(id)) {
            tableModel.addRow(new Object[]{
                model.getId(),
                model.getName(),
                model.getLoadCategory(),
    ...
    public int readTableDatabaseForName(String name) {
        ...
        ModelProductDAO modelDao = new ModelProductDAO();
        int i = 0;
        for (ModelProduct model : modelDao.readName(name)) {
            tableModel.addRow(new Object[]{
                model.getId(),
                model.getName(),
                model.getLoadCategory(),
    ...
    private void initComponents() {
        ...
        jTextFieldStackingMaxCapacity = new javax.swing.JTextField();
        ...
        jLabel2.setText("Capacidade máxima de empilhamento");

        jTextFieldStackingMaxCapacity.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldStackingMaxCapacityActionPerformed(evt);
            }
        });
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldProductCategory, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            .addComponent(jButtonClean, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(110, 110, 110)
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(jTextFieldStackingMaxCapacity, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(95, 95, 95))
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, 0)
                        .addComponent(jTextFieldStackingMaxCapacity, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(jButtonClean, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(74, Short.MAX_VALUE))
        );

        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 20, 360, 270));
        ...
        jLabel10.setText("Manipulação do banco:");
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 240, 110));
        ...
        jLabel11.setText("Manipulação de arquivos:");
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jButtonSaveBinary, javax.swing.GroupLayout.DEFAULT_SIZE, 203, Short.MAX_VALUE)
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 240, 150));

        jTabbedPane1.addTab("Cadastrar", jPanel1);

        jButtonSearch.setBackground(new java.awt.Color(255, 102, 0));
        jButtonSearch.setForeground(new java.awt.Color(255, 255, 255));
        jButtonSearch.setText("Carregar");
        ...
        jTableDistributor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome do produto", "Categoria do produto", "Capacidade máxima de empilhamento"
            }
        ) {
        ...
        jTabbedPane1.addTab("Buscar em arquivo", jPanel3);
        ...
        jTableDistributorDatabase.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nome do produto", "Categoria do produto", "Capacidade máxima de empilhamento"
            }
        ) {
            Class[] types = new Class [] {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jButtonClean2, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(264, 264, 264)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButtonClean2, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jMenuItemSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemSaveActionPerformed
        ...
        if (sair == 0) {
            controller.writeProduct(list, true);
            list = null;
        }
    ...
    private void jButtonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSearchActionPerformed
        ...
        loadTable(controller.getProduct());
...
//        }
    ...
    private void jButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegisterActionPerformed
        ...
        model.setLoadCategory(jTextFieldProductCategory.getText());
        model.setStackingCapacity(jTextFieldStackingMaxCapacity.getText());
    ...
    private void jTextFieldStackingMaxCapacityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldStackingMaxCapacityActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldStackingMaxCapacityActionPerformed
        ...
        if (controllerBinary.getFile() != null) {
            if (controllerBinary.readContentList()) {
                ...
                for (int i = 0; i < listListObj.size(); i++) {
                    ...
                    list.add((ModelProduct) listListObj.get(i));
                }
                //                for (int i = 0; i < listObj.size(); i++) {
                //                    System.err.println(listObj.get(i));
                //                    list.add((ModelProduct) listObj.get(i));
                //                }
    ...
    private void jButtonRegister2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegister2ActionPerformed
        if ("".equals(jTextFieldName.getText()) || "".equals(jTextFieldProductCategory.getText()) || "".equals(jTextFieldStackingMaxCapacity.getText())) {
    ...
    private void jButtonRegister1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegister1ActionPerformed
        if (jTableDistributorDatabase.getSelectedRow() != -1) {
            ...
            try {
                ...
                model.setId(Integer.parseInt(jTextFieldId.getText()));
                model.setName(jTextFieldName.getText());
                model.setLoadCategory(jTextFieldProductCategory.getText());
                model.setStackingCapacity(jTextFieldStackingMaxCapacity.getText());
    ...
    private void jTableDistributorDatabaseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableDistributorDatabaseMouseClicked
        if (jTableDistributorDatabase.getSelectedRow() != -1) {
            ...
            jTextFieldProductCategory.setText(jTableDistributorDatabase.getValueAt(jTableDistributorDatabase.getSelectedRow(), 2).toString());
            jTextFieldStackingMaxCapacity.setText(jTableDistributorDatabase.getValueAt(jTableDistributorDatabase.getSelectedRow(), 3).toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewRegisterProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewRegisterProduct().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTextFieldStackingMaxCapacity;
